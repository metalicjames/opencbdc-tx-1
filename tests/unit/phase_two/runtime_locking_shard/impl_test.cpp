...
TEST(runtime_locking_shard_test, basic_test) {
    ...
    maybe_success = shard.prepare(
        ticket_number,
        {{key, new_val}},
        [](std::optional<cbdc::threepc::runtime_locking_shard::error_code>
               ret) {
...
TEST(runtime_locking_shard_test, lock_not_given_test) {
        ...
        [&](cbdc::threepc::runtime_locking_shard::interface::
            ...
            ASSERT_EQ(
                std::get<cbdc::threepc::runtime_locking_shard::error_code>(
                    ret),
                cbdc::threepc::runtime_locking_shard::error_code::lock_queued);
        });
    ASSERT_TRUE(maybe_success);
    ...
    maybe_success = shard.prepare(
        ...
        [](std::optional<cbdc::threepc::runtime_locking_shard::error_code>
            ...
            ASSERT_TRUE(ret.has_value());
            ASSERT_EQ(ret.value(),
                      cbdc::threepc::runtime_locking_shard::error_code::
                          lock_not_held);
        });
    ASSERT_TRUE(maybe_success);
    ...
    maybe_success = shard.try_lock(
        ...
        [&](cbdc::threepc::runtime_locking_shard::interface::
            ...
            ASSERT_EQ(
                std::get<cbdc::threepc::runtime_locking_shard::error_code>(
                    ret),
                cbdc::threepc::runtime_locking_shard::error_code::prepared);
        });
    ASSERT_TRUE(maybe_success);
