    ...
    auto agent = std::make_shared<cbdc::threepc::agent::impl>(
        ...
        [&](const cbdc::threepc::agent::interface::exec_return_type& res) {
            ASSERT_TRUE(std::holds_alternative<
                        cbdc::threepc::agent::interface::error_code>(res));
            ASSERT_EQ(
                std::get<cbdc::threepc::agent::interface::error_code>(res),
                cbdc::threepc::agent::interface::error_code::
                    function_execution);
...
TEST_F(agent_test, wound_deploy_test) {
    ...
    auto broker1 = std::make_shared<cbdc::threepc::broker::impl>(
        1,
        std::vector<
