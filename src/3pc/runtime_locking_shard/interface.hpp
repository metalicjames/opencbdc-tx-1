...
#ifndef CBDC_UNIVERSE0_SRC_3PC_RUNTIME_LOCKING_SHARD_INTERFACE_H_
#define CBDC_UNIVERSE0_SRC_3PC_RUNTIME_LOCKING_SHARD_INTERFACE_H_
...
namespace cbdc::threepc::runtime_locking_shard {
    ...
    using ticket_number_type = threepc::ticket_machine::ticket_number_type;
    ...
    class interface {
      public:
        ...
        using try_lock_return_type = std::variant<value_type, error_code>;
        ...
        /// Return type from a prepare operation. An error code, if applicable.
        using prepare_return_type = std::optional<error_code>;
        ...
        using commit_return_type = std::optional<error_code>;
        ...
        /// applicable.
        using rollback_return_type = std::optional<error_code>;
