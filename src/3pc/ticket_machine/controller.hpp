...
#ifndef CBDC_UNIVERSE0_SRC_3PC_TICKET_MACHINE_CONTROLLER_H_
#define CBDC_UNIVERSE0_SRC_3PC_TICKET_MACHINE_CONTROLLER_H_
...
namespace cbdc::threepc::ticket_machine {
    ...
    class controller {
      ...
      private:
        ...
        static constexpr auto m_batch_size = 25;
    };
}
