...
namespace cbdc::threepc::broker {
    ...
    class interface {
      public:
        ...
        using try_lock_return_type = std::
            variant<value_type, error_code, runtime_locking_shard::error_code>;
        ...
        virtual auto recover(recover_callback_type result_callback) -> bool
            = 0;
    };
}
